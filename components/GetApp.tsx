...
export default function GetApp() {
  return (
    <div>
      <section className="text-gray-600 body-font overflow-hidde shadow-lg p-16 mb-5 bg-body roundedn ">
          ...
          <div className="-my-8 divide-y-2 divide-gray-100">
            <div className="py-8 flex flex-wrap md:flex-nowrap">
              ...
              <div className="md:flex-grow">
                ...
                >
                  คลิกตรวจวินิจฉัยหัวใจได้ที่นี่
                  <svg
            ...
            <div className="py-8 flex flex-wrap md:flex-nowrap">
              ...
              <div className="md:flex-grow">
                ...
                คลิกตรวจวินิจฉัยโรคมะเร็งผิวหนังได้ที่นี่
                  <svg
                    className="w-4 h-4 ml-2"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
